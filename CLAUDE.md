...
| SCD41 (CO2) | ~3 mA | ~205 mA | low-power periodic mode (30 s); peak is a short pulse, buffered by the module's own ceramic caps; no extra bulk cap fitted (a tested 47 µF / 25 V is on hand if `PWR NO` ever shows) |
